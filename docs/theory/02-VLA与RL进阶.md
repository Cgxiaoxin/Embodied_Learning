...
| 文档 | 内容 |
|------|------|
| [01-VLA算法入门](./01-VLA算法入门.md) | VLA 基础概念、训练框架与工具生态 |
| [π0.5 项目实践](../projects/π0.5双臂L6折纸VLA与SAC微调项目实践.md) | RECAP / SAC 真机落地细节 |
| [面试知识储备 §15](../../interview/面试知识储备.md#15-轨迹插值拟合与实时检索) | VLA 低延迟与轨迹后处理 |
